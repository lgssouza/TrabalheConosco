...
* Área de desenvolvimento C++ (6 vagas)
* Área de desenvolvimento Web (3 vagas)
...
* Bibliotecas (STL, Boost etc.);
* Paixão por programar!
* Faculdade nas áreas de computação (Ciencias ou Engenharia da Computação);

**Diferencial**

* Faculdade, Mestrado, e/ou Doutorado em computação, ou área técnica relevante.
* Experiência sólida em design e arquitetura de software.
* Excelência em Python.
